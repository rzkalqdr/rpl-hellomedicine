...
<div class="col-lg-12">
    <form action="/dashboard/dokter/<?php echo e($dokter->idDokter); ?>" method="POST">
        <?php echo csrf_field(); ?>
        <?php echo method_field('PUT'); ?>
            ...
            <div class="row mb-3">
                ...
                <input type="text" class="form-control" name="idDokter" required value="<?php echo e(old('idDokter', $dokter->idDokter)); ?>" readonly> 
            </div>
            <div class="row mb-3">
...
unset($__errorArgs, $__bag); ?>" aria-label=".form-select-sm example" name="idUser" required">
                    <?php $__currentLoopData = $user; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $usr): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php if(old('idUser', $dokter->idUser) == $usr->idUser): ?>
...
unset($__errorArgs, $__bag); ?>" name="namaDokter" required value="<?php echo e(old('namaDokter', $dokter->namaDokter)); ?>"> 
...
unset($__errorArgs, $__bag); ?>" name="Spesialisasi" required value="<?php echo e(old('Spesialisasi', $dokter->Spesialisasi)); ?>"> 
...
unset($__errorArgs, $__bag); ?>" name="NomorSTR" required value="<?php echo e(old('NomorSTR', $dokter->NomorSTR)); ?>"> 
...
<?php echo $__env->make('dashboardAdmin.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\TELU\Semester 6\RPL\web-hellmed\resources\views/dashboardAdmin/dokter/edit.blade.php ENDPATH**/ ?>
    ...
    <div class="container mt-3">
        <div class="form-group">
            <form action="/admin/rumahsakit/store" method="post">
                ...
                <br><br>
                <label for="nama">Nama Rumah Sakit</label> <input type="text" name="nama" id="nama" required="required" class="form-control">
                <br><br>
                <label for="alamat">Alamat Rumah Sakit</label> <textarea name="alamat" id="alamat" cols="30" rows="10" class="form-control"></textarea>
                <br><br>

  ...
  <body>
    <nav class="navbar navbar-expand-lg navbar-light bg-light border-bottom">
      <div class="container-fluid">
        ...
        <div class="col-2">
          <div class="text-end">
            <button class="btn btn-outline-success me-2" type="button" style="margin-right: 30px;">Login</button> 
    ...
    <div class=" p-5 mb-4 rounded-3">
      <div class="container-fluid py-5">
        <h1 class="display-5" style="font-weight:1000; font-size: 29px; margin-left: 10px; color: #72C985;">Artikel Keseshatan</h1>
...
</html><?php /**PATH C:\Users\LENOVO\Documents\GitHub\rpl-hellomedicine\resources\views/artikel.blade.php ENDPATH**/ ?>